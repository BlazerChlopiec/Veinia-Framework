...
namespace GeonBit.UI
{
	...
	public class UserInterface : System.IDisposable
	{
		...
		/// <summary>
		/// VEINIA/ Getting if the mouse hovers over any element
		/// </summary>
		...
		public void Update(GameTime gameTime)
		{
			...
			// VEINIA/ update IsMouseInteracting
			UserInterface.Active.IsMouseInteracting = false;
		...
		/// <summary>
		/// VEINIA/ Removes all entities from the root panel
		/// </summary>
